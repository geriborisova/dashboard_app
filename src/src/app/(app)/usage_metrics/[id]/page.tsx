...
import { getUsageMetrics } from '@/data'
...
export default async function UsageMetrics() {
  let usageMetrics = await getUsageMetrics();

  return (
    <>
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div className="max-sm:w-full sm:flex-1">
          <Heading>Usage Metrics</Heading>
        ...
        {/* {usageMetrics.map((usageMetric, index) => (
          <li key={index}>
            ...
            <div className="flex items-center justify-between">
              <div key={usageMetric} className="flex gap-6 py-6">
                <div className="w-32 shrink-0">
                  <Link href={usageMetric.tena} aria-hidden="true">
